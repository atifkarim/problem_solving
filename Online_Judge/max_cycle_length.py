...
print(round(first_num))
print(round(second_num))
# print(first_num)
...
def take_number(first_num, second_num):
    first_num = round(first_num)
    # f1 = int(first_num)
    # print('here: ', f1, ' ,type:', type(f1))
    # print(second_num)
    # print(type(second_num))
    second_num = round(second_num)
    # print('here: ', g1, ' ,type:', type(g1))
    ...
    return int(maximal_length_array.max())

length_size = take_number(first_num, second_num)
