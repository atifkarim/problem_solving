...
class PageRank:
    ...
    def power_method(self, number_of_pages, transition_matrix):
        ...
        for i in range(self.max_iterations):
            ...
            logging.debug("step {} {}".format(i,new_ranks))
    ...
    def create_page_rank(self, pages):
        ...
        logging.debug("transition_matrix {}" .format(transition_matrix))
...
class SearchEngine():
    ...
    def search(self, query):
        ...
        logging.debug("cosine_similarity_scores {}" .format(cosine_similarity_scores))
...
def test_search_engine(pages):
    ...
    engine.start(pages)
    logging.debug("page_rank{}" .format(engine.page_rank))
